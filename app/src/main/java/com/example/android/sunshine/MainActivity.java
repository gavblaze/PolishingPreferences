...
// DONE (7) Override onStart & if preferences have been changed, refresh the data (ie restart loader) and set the flag to false
...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean PREF_VALUE_HAS_CHANGED = false;
    ...
    protected void onStart() {
        super.onStart();
        if (PREF_VALUE_HAS_CHANGED) {
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);
            PREF_VALUE_HAS_CHANGED = false;
        }
    }
